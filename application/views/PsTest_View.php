...
<body style="padding: 10px;">
    <div class="row">
        ...
        <div class="col-2">
            <button onclick="resetForm()" type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#nouveauidentite">
                Nouveau
            </button>
        </div>

        <!-- Modal -->
        <div class="modal fade modal-xl" id="nouveauidentite" tabindex="-1" aria-labelledby="nouveauidentiteLabel"
            aria-hidden="true">
    ...
    // code...
    ?>
                                        <option value="<?=$keyetat_civil['ETAT_CIVIL_ID']?>">
                                            <?=$keyetat_civil['DESCRIPTION']?></option>
                                        <?php }?>
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-control" id="PROVINCE_ID" name="PROVINCE_ID"
                                        onchange="getLocaliteByParent(this.value,'COMMUNE_ID',1)">
                                        <option value="">Select</option>
                                        <?php foreach ($provinces as $keyprovinces) {
    // code...
    ?>
                                        <option value="<?=$keyprovinces['PROVINCE_ID']?>">
                                            <?=$keyprovinces['PROVINCE_NAME']?></option>
                                        <?php }?>
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-control" id="COMMUNE_ID" name="COMMUNE_ID"
                                        onchange="getLocaliteByParent(this.value,'ZONE_ID',2)">
                                        <option value="">Select</option>
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-control" id="ZONE_ID" name="ZONE_ID"
                                        onchange="getLocaliteByParent(this.value,'COLLINE_ID',3)">
                                        <option value="">Select</option>
    ...
    ?>
                        ...
                        <input type="hidden" id="dynamictext" value="Voulez vous enregistrer cette donnee?">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                        <button id="btnenregistr" type="button" class="btn btn-primary"
                            onclick="addData()">Enregistrer</button>
                    </div>
                </div>
            </div>
        </div>
...
function resetForm() {
    // body...
    $('#formidentite').get(0).reset();
    $('select option').removeAttr('selected');
    $('#btnenregistr').html('Enregistrer')
}
</script>
<script type="text/javascript">
...
function deleteData(IDENTITE_ID) {
    ...
    Swal.fire({
        title: 'Are you sure?',
        text: "Vous ne pourrez pas revenir en arrièr!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
